"""Pure batch accumulator for the Kafka -> Iceberg bronze follows write.

Mirror of ``batch.py`` for the follow event type: holds decoded FollowRows until a flush
...
from bsky_dagster.transforms.bronze_schema_follows import follows_arrow_schema
...
class FollowsBatch:
    ...
    def to_arrow(self) -> pa.Table:
        """Materialize the held rows as a pyarrow Table matching the bronze follows schema."""
        ...
        for r in self._rows:
            ...
            columns["subject_did"].append(r.subject_did)
